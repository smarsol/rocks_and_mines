...
for gamma_test in gammas:
  ...
  cost_total.append((tn * 200 +fn * 1200 + tp * 1000 + fp * 300)/total)

fig = plt.figure()
plt.plot(gammas, cost_total, 'o--')
plt.xlabel(u"Gamma [\u03B3]", fontsize = 18)
plt.ylabel("Cost total (euros)", fontsize = 18)
fig.tight_layout()
fig.savefig("figure_cost.png")
